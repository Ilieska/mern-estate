          ...
          <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
              <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>  
                  ...
                  <div className='flex items-center gap-2'>
                      <input type="Number" id='regularPrice' min='50' max='10000000'
                      className='p-2 border border-gray-300 rounded-lg' required 
                      onChange={handleChange} 
                  ...
                  {formData.offer && (
                     <div className='flex items-center gap-2'>
                     <input type="Number" id='discountPrice' min='10' max='10000000'
                     className='p-2 border border-gray-300 rounded-lg' required 
                     onChange={handleChange} 
              ...
              <div className='flex flex-col fle x-1 gap-4'>
                ...
                <div className='flex gap-4 items-center'>
                  <input onChange={(e) => setFiles(e.target.files)} className='p-3 border border-gray-200 rounded w-full' type="file" id='images' accept='image/*' multiple  />
                  <button  type='button' disabled={uploading} onClick={handleImageSubmit} className='h-10 p-2 bg-green-50 text-green-700 border border-green-700 text-center
                ...
                <button disabled={loading || uploading} className='bg-slate-700 text-white p-3 rounded-xl 
              uppercase text-center hover:opacity-95 disabled:opacity-80'> 
